    ...
    return ( 
          <div className="bg-[#212529] font-fomofont w-[46vw] sm:w-full p-4 sm:p-3 rounded-b-2xl rounded-r-2xl">
            ...
            <div className="flex items-center text-sm font-fomofont font-normal my-3 sm:my-5">
              <button className="border border-[#ffc107] w-full   h-16 hover:bg-[#ffc107] rounded-l-md hover:text-black  py-2  border-r-0 text-[#ffc107] sm:text-[1rem]">+ 1 Key</button>
              <button className="border border-[#ffc107] w-full   h-16 hover:bg-[#ffc107] hover:text-black  border-r-0  py-2  text-[#ffc107] sm:text-[1rem]">+ 2 Keys</button>
              <button className="border border-[#ffc107] h-16 hover:bg-[#ffc107] hover:text-black px-11 sm:px-5 py-2 border-r-0 text-[#ffc107] sm:text-[1rem]">+ <br />5</button>
              <button className="border border-[#ffc107] h-16 hover:bg-[#ffc107] hover:text-black px-11 sm:px-5 py-2 border-r-0 text-[#ffc107] sm:text-[1rem]">+ <br />10</button>
              <button className="border border-[#ffc107] h-16 hover:bg-[#ffc107] rounded-r-md hover:text-black px-12 sm:px-6 py-2 text-[#ffc107] sm:text-[1rem]">+ <br />100</button>
            </div>
