            ...
            <div className="relative w-2/3 font-fomofont h-full mt-24 sm: sm:mt-2 sm:w-full p-6 sm:p-2">
                <div className="relative bg-[#212529] p-6 rounded-lg shadow">
                    <div className="flex mb-5  justify-between">
                        <h1 className='text-white text-2xl' style={{ textShadow: "0 0 2px #690069, 0 0 25px #c0c, 0 0 5px #f0f" }}>How to play Fomo3D</h1>
                    ...
                    <p className="text-base text-white my-4 font-light  font-fomofont">Buy a key by choosing the amount of keys you want, choosing the team and then clicking on the <b className='font-bold'>SEND BNB</b> button.</p>
                    ...
                    <p className="text-base text-white font-light  font-fomofont">Just register a name for <b className='font-bold' style={{ textShadow: ' gold 0px 0px 10px, gold 0px 0px 10px' }}>0.01 BNB </b>in the <b className='font-bold'>Vanity & Referrals</b> tab.</p>
                    ...
                    <p className="text-base text-white my-1 font-light mb-5 font-fomofont">Once your name is registered, a <b className='font-bold'>Vanity Referral </b> link will be made for you. For example <a className='font-bold text-[#0d6efd]' href="/">fomo3d.net/inventor</a>.</p>
